...
<section class="why-section">
  <h2 class="why-title">Warum bei LernCoding lernen:</h2>
  ...
  <div class="features-grid">
    ...
    <div class="feature-card">
      ...
      <div class="feature-content">
        <p class="feature-text">
          Werde Teil unserer lebendigen Lern-Community.
        </p>
      </div>
    </div>
    ...
    <div class="feature-card">
      ...
      <div class="feature-content">
        <p class="feature-text">
          Lerne kostenlos und in deinem eigenen Tempo.
        </p>
      </div>
    </div>
    ...
    <div class="feature-card">
      ...
      <div class="feature-content">
        <p class="feature-text">
          Verbessere deine technischen Fähigkeiten mit unseren Projekten.
        </p>
      </div>
    </div>
     ...
     <div class="feature-card">
      <div class="icon">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  <path d="M4.93 4.93a10 10 0 1 1-1.41 1.41"></path>
  <polyline points="4 4 10 4 10 10"></polyline>
      ...
      <div class="feature-content">
        <p class="feature-text">
          Profitiere von ständigen Updates und neuen Inhalten.
        </p>
      </div>
    </div>
...
<!-- =============================================
     RESPONSIVER FOOTER – ganz unten
============================================= -->
<footer class="site-footer" >
  <div class="footer-container">

    <!-- Obere Reihe: Logo + Kurzbeschreibung + Socials -->
    <div class="footer-top">
      <div class="footer-brand">
        <h3>LernCoding</h3>
        <p>Programmieren lernen – interaktiv, kostenlos und auf Deutsch.</p>
      </div>

      <div class="footer-social">
        <a href="https://www.tiktok.com/@codehxb" target="_blank" rel="noopener" aria-label="TikTok">
          <svg viewBox="0 0 24 24"><path d="M16.5 1c.7 4.2 3.3 6 6.5 6v3c-2.2.1-4.2-.7-6.5-2.2v7.7c0 3.8-3.1 6.8-6.9 6.8S3 19.3 3 15.5 6.1 8.7 9.9 8.7c.4 0 .8 0 1.2.1v3.8c-.4-.1-.8-.2-1.2-.2-1.7 0-3.1 1.4-3.1 3.1s1.4 3.1 3.1 3.1 3.1-1.4 3.1-3.1V1h3.5z"/></svg>
        </a>
        <a href="https://www.youtube.com/@LernCoding2026" target="_blank" rel="noopener" aria-label="YouTube">
          <svg viewBox="0 0 24 24"><path d="M23.5 6.2s-.2-1.7-.9-2.4c-.9-.9-1.9-.9-2.4-1C16.8 2.5 12 2.5 12 2.5h0s-4.8 0-8.2.3c-.4.1-1.5.1-2.4 1C.7 4.5.5 6.2.5 6.2S0 8.1 0 10v1.9c0 1.9.5 3.8.5 3.8s.2 1.7.9 2.4c.9.9 2.1.9 2.6 1 1.9.2 8 .3 8 .3s4.8 0 8.2-.3c.4-.1 1.5-.1 2.4-1 .7-.7.9-2.4.9-2.4s.5-1.9.5-3.8V10c0-1.9-.5-3.8-.5-3.8zM9.5 14.5v-5l5 2.5-5 2.5z"/></svg>
        </a>
        <a href="https://discord.gg/codebase" target="_blank" rel="noopener" aria-label="Discord">
          <svg viewBox="0 0 24 24"><path d="M20.3 4.3A19.5 19.5 0 0 0 16 3l-.2.4a18.2 18.2 0 0 1 4.1 2.1c-3.9-1.9-7.9-1.9-11.8 0A18.2 18.2 0 0 1 12.2 3l-.2-.4a19.5 19.5 0 0 0-4.3 1.3C3.9 9 2.9 14.2 3.3 19.3a19.9 19.9 0 0 0 6.1 3.1l.7-.9a12.6 12.6 0 0 1-1.9-.9l.4-.3c3.7 1.7 7.7 1.7 11.4 0l.4.3c-.6.3-1.2.6-1.9.9l.7.9a19.9 19.9 0 0 0 6.1-3.1c.4-5.1-.6-10.3-3.6-15zM9.5 15.3c-1 0-1.8-.9-1.8-2s.8-2 1.8-2 1.8.9 1.8 2-.8 2-1.8 2zm5 0c-1 0-1.8-.9-1.8-2s.8-2 1.8-2 1.8.9 1.8 2-.8 2-1.8 2z"/></svg>
        </a>
      </div>
    </div>
    ...
    <div class="footer-links-grid">
      <div class="footer-column">
        <h4>Plattform</h4>
        <ul>
          <li><a href="https://lern-coding.de" onclick="showStartPage(); return false;">Startseite</a></li>
          <li><a href="https://www.youtube.com/@LernCoding2026" onclick="showVideosPage(); return false;">Videos</a></li>
        </ul>
      </div>
      ...
      <div class="footer-column">
        <h4>Rechtliches</h4>
        <ul>
          <li><a href="#" onclick="showImpressum(); return false;">Impressum</a></li>
          <li><a href="#" onclick="showAGB(); return false;">AGB & Datenschutz</a></li>
          <li><a href="#" onclick="document.getElementById('cookie-banner')?.classList.remove('hidden'); return false;">Cookie-Einstellungen</a></li>
        </ul>
      </div>
    </div>
    ...
    <div class="footer-bottom">
      <p>© 2026 LernCoding – Alle Rechte vorbehalten.</p>
      <p>Mit <span style="color:#f87171;">♥</span> in Hamburg gemacht</p>
    </div>
